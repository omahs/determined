...
def get_agent_id_device_type(sess: api.Session, allocation_id: str):
...
def get_device_type(sess: api.Session, allocation_id: str, agent_id: str):
    task_res = bindings.get_GetTasks(sess)
    allocations = task_res.allocationIdToSummary
...
if __name__ == "__main__":
    ...
    if args.resources:
        ...
        logging.info(
            f"Running task container on agent_id={agent_id} "
