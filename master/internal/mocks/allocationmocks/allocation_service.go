...
// SetAcceleratorData provides a mock function with given fields: ctx, containerID, id, taskID, nodeName, acceleratorType, accelerators
func (_m *AllocationService) SetAcceleratorData(ctx context.Context, containerID string, id model.AllocationID, taskID model.TaskID, nodeName string, acceleratorType string, accelerators []string) error {
	ret := _m.Called(ctx, containerID, id, taskID, nodeName, acceleratorType, accelerators)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, model.AllocationID, model.TaskID, string, string, []string) error); ok {
		r0 = rf(ctx, containerID, id, taskID, nodeName, acceleratorType, accelerators)
	} else {
		r0 = ret.Error(0)
	}
